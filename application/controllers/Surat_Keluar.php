...
class Surat_Keluar extends CI_Controller
{
    ...
    {
        $data['surat_keluar'] = $this->m_surat->get_all_surat_by_id_jenis_surat(2)->result_array();
    ...
    public function edit_surat()
    {
        ...
        if ($hasil == false) {
            ...
            redirect('Surat_Keluar/view_surat_keluar');
    ...
    public function edit_file_nota_dinas_admin_utama()
    {
        ...
        if ($file_nota_dinas_upload) {
            ...
            $this->session->set_flashdata('eror', 'eror');
            redirect('Surat_Keluar/view_admin_utama_surat_keluar');
        }
    ...
    public function view_admin_utama_surat_keluar()
    {
        $data['surat'] = $this->m_surat->get_all_surat_by_id_jenis_surat_and_id_status_surat(2, 1)->result_array();
        $this->load->view('admin_utama/surat_keluar', $data);
    }

    public function acc_surat_keluar()
    {
        $id_surat = $this->input->post("id_surat");
    ...
    public function tolak_surat_keluar()
    {
        $id_surat = $this->input->post("id_surat");
