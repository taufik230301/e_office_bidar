                                        ...
                                        <div class="card-body">
                                            ...
                                            ?>
                                                    <tr>
                                                        ...
                                                        <td>
                                                            <button type="button" data-toggle="modal"
                                                                data-target="#edit_data_surat<?=$id?>"
                                                                class="btn btn-primary m-2">Edit</button>
                                                        ...
                                                        <div class="modal-dialog">
                                                            <div class="modal-content">
                                                                ...
                                                                <div class="modal-footer">
                                                                    ...
                                                                    <form
                                                                        action="<?=base_url();?>Surat_Keluar/hapus_surat"
                                                                        method="POST">
                                                    ...
                                                    <div class="modal fade" id="edit_data_surat<?=$id?>" tabindex="-1"
                                                        ...
                                                        <div class="modal-dialog">
                                                            <div class="modal-content">
                                                                ...
                                                                <div class="modal-body">
                                                                    <form
                                                                        action="<?=base_url();?>Surat_Keluar/edit_surat"
                                                    ...
                                                    <div class="modal fade" id="ubah_file_surat<?=$id?>" tabindex="-1"
                                                        ...
                                                        <div class="modal-dialog">
                                                            <div class="modal-content">
                                                                ...
                                                                <div class="modal-body">
                                                                    <form
                                                                        action="<?=base_url();?>Surat_Keluar/edit_file_surat"
                                                                        method="post" enctype="multipart/form-data">
                                                    ...
                                                    <div class="modal fade" id="ubah_file_nota_dinas<?=$id?>"
                                                        ...
                                                        <div class="modal-dialog">
                                                            <div class="modal-content">
                                                                ...
                                                                <div class="modal-body">
                                                                    <form
                                                                        action="<?=base_url();?>Surat_Keluar/edit_file_nota_dinas"
                                                                        method="post" enctype="multipart/form-data">
                                                                        <input type="text" id="id_surat" name="id_surat"
                                                                            value="<?=$id_surat?>" hidden>
                                                                        <div class="form-group">
