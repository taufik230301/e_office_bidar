                    ...
                    <div class="row mb-2">
                        ...
                        <div class="col-sm-6">
                            <ol class="breadcrumb float-sm-right">
                                ...
                                <li class="breadcrumb-item active">Surat PKS</li>
                            </ol>
                        </div><!-- /.col -->
                    </div><!-- /.row -->
                </div><!-- /.container-fluid -->
                                ...
                                <div class="col-12">
                                    ...
                                    <div class="card">
                                        <div class="card-header">
                                            <h3 class="card-title">Data Surat PKS</h3>
                                        </div>
                                        <!-- /.card-header -->
                                        <div class="card-body">
                                                        ...
                                                        <div class="modal-dialog">
                                                            <div class="modal-content">
                                                                ...
                                                                <div class="modal-footer">
                                                                    ...
                                                                    <form
                                                                        action="<?=base_url();?>Pks/hapus_surat"
                                                                        method="POST">
                                                    ...
                                                    <div class="modal fade" id="edit_data_surat<?=$id?>" tabindex="-1"
                                                        ...
                                                        <div class="modal-dialog">
                                                            <div class="modal-content">
                                                                ...
                                                                <div class="modal-body">
                                                                    <form
                                                                        action="<?=base_url();?>Pks/edit_surat"
                                                ...
                                                <div class="modal fade" id="ubah_file_surat<?=$id?>" tabindex="-1"
                                                    ...
                                                    <div class="modal-dialog">
                                                        <div class="modal-content">
                                                            ...
                                                            <div class="modal-body">
                                                                <form action="<?=base_url();?>Pks/edit_file_surat"
                                                                    method="post" enctype="multipart/form-data">
                                            ...
                                            <div class="modal fade" id="exampleModal" tabindex="-1"
                                                ...
                                                <div class="modal-dialog">
                                                    <div class="modal-content">
                                                        ...
                                                        <div class="modal-body">
                                                            <form action="<?=base_url();?>Pks/tambah_surat_pks"
                                                                method="post" enctype="multipart/form-data">
                                                                <div class="form-group">
                                                                    <label for="perihal">Perihal</label>
