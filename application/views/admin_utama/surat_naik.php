                                    ...
                                    <div class="card">
                                        ...
                                        <div class="card-body">
                                            ...
                                            ?>
                                                    <tr>
                                                        ...
                                                        <td>
                                                            <button type="button" class="btn btn-primary m-2"
                                                                data-toggle="modal"
                                                                data-target="#acc_surat_naik<?=$id?>">Acc</button>

                                                            <button type="button" class="btn btn-danger m-2"
                                                                data-toggle="modal"
                                                                data-target="#tolak_surat_naik<?=$id?>">Tolak</button>
                                                        ...
                                                        <div class="modal-dialog">
                                                            <div class="modal-content">
                                                                ...
                                                                <div class="modal-body">
                                                                    <form
                                                                        action="<?=base_url();?>Surat_Naik/edit_file_surat_admin_utama"
                                                    ...
                                                    <div class="modal fade" id="ubah_file_nota_dinas<?=$id?>"
                                                        ...
                                                        <div class="modal-dialog">
                                                            <div class="modal-content">
                                                                ...
                                                                <div class="modal-body">
                                                                    <form
                                                                        action="<?=base_url();?>Surat_Naik/edit_file_nota_dinas_admin_utama"
                                                                        method="post" enctype="multipart/form-data">
                                                    ...
                                                    <div class="modal fade" id="acc_surat_naik<?=$id?>" tabindex="-1"
                                                        aria-labelledby="exampleModalLabel" aria-hidden="true">
                                                        <div class="modal-dialog">
                                                            <div class="modal-content">
                                                                <div class="modal-header">
                                                                ...
                                                                <div class="modal-footer">
                                                                    ...
                                                                    <form
                                                                        action="<?=base_url();?>Surat_Naik/acc_surat_naik"
                                                                        method="POST">
                                                                        <input type="text" id="id_surat" name="id_surat"
                                                                            value="<?=$id_surat?>" hidden>
                                                                        <button type="submit"
                                                    ...
                                                    <div class="modal fade" id="tolak_surat_naik<?=$id?>" tabindex="-1"
                                                        aria-labelledby="exampleModalLabel" aria-hidden="true">
                                                        <div class="modal-dialog">
                                                            <div class="modal-content">
                                                                <div class="modal-header">
                                                                ...
                                                                <div class="modal-footer">
                                                                    ...
                                                                    <form
                                                                        action="<?=base_url();?>Surat_Naik/tolak_surat_naik"
                                                                        method="POST">
                                                                        <input type="text" id="id_surat" name="id_surat"
                                                                            value="<?=$id_surat?>" hidden>
                                                                        <button type="submit"
